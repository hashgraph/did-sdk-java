...
public class HcsDidNetworkBuilder {
  ...
  public HcsDidNetwork execute(final Client client) throws HederaNetworkException, HederaStatusException {
    ...
    HcsDidNetworkAddressBook addressBook = HcsDidNetworkAddressBook
    ...
    return HcsDidNetwork.fromAddressBook(network, addressBook);
  }
   ...
   */
  public HcsDidNetworkBuilder buildAndSignDidTopicCreateTransaction(
   ...
   * @return         This identity network builder instance.
   */
  public HcsDidNetworkBuilder buildAndSignVcTopicCreateTransaction(
      final Function<ConsensusTopicCreateTransaction, Transaction> builder) {
   ...
   * @return         This identity network builder instance.
   */
  public HcsDidNetworkBuilder buildAndSignAddressBookCreateTransaction(
   ...
   * @return           This identity network builder instance.
   */
  public HcsDidNetworkBuilder addAppnetDidServer(final String serverUrl) {
    if (didServers == null) {
   ...
   * @return            This identity network builder instance.
   */
  public HcsDidNetworkBuilder setAppnetName(final String appnetName) {
   ...
   * @return            This identity network builder instance.
   */
  public HcsDidNetworkBuilder setDidTopicId(final ConsensusTopicId didTopicId) {
   ...
   * @return           This identity network builder instance.
   */
  public HcsDidNetworkBuilder setVCTopicId(final ConsensusTopicId vcTopicId) {
   ...
   * @return         This identity network builder instance.
   */
  public HcsDidNetworkBuilder setNetwork(final HederaNetwork network) {
